...
\input{logica/inleiding.tex}
\input{logica/proposities}
\input{logica/verzamelingen}
\input{logica/predicaten}

\part{Hardware}
\input{hardware/cpu}

\part{Coding Skills}
\input{codeskills/linux}
\input{codeskills/git}
...
\input{extra/bewijzen}
\input{extra/bewijsmethoden}
\input{extra/inductie}
\input{extra/functies}
\input{extra/relational-model}
%\input{hardware/float}

\part{Uitwerkingen}
\input{logica/uitwerkingen/uitwerking-prop.tex}
\input{logica/uitwerkingen/uitwerking-set.tex}
\input{logica/uitwerkingen/uitwerking-sem.tex}
\input{logica/uitwerkingen/uitwerking-pred.tex}
\input{logica/uitwerkingen/uitwerking-boom.tex}
\input{logica/uitwerkingen/uitwerking-bewijzen.tex}
\input{logica/uitwerkingen/uitwerking-ind.tex}
